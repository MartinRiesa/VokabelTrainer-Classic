# config.py - Enthält alle Konfigurationskonstanten und Pfaddefinitionen
...
MAP_SMALL          = (200, 200)          # Minikarte im Hauptfenster
MAP_LARGE          = (1024, 860)         # Übersichtskarte nach jedem Level
